# Node.js (Next.js) service for Wodby

Use Node.js (Next.js) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Node.js (Next.js) service in the Wodby catalog.

- [Node.js (Next.js) service in the Wodby catalog](https://wodby.com/services/nextjs)
...
4. Reference `nextjs` from your stack manifest.
